...
export const en = {
  ...
  profile: {
    ...
    yourName: "Your name",
    yourNameNote:
      "Shown next to your address to anyone who looks you up. Anyone can pick any name, so it is a label rather than proof — your address is what identifies you.",
    unnamed: "Unnamed",
    nameLabel: "Your name",
    save: "Save",
  ...
  settingsMore: {
    ...
    light: "Light",
    dark: "Dark",
    phoneIs: "Your phone is set to {{palette}} right now.",
    composeTitle: "New chat button",
    composeNote:
      "Floating puts it under your thumb but over the last rows of the list. In the header it covers nothing, and matches the other tabs.",
    floating: "Floating",
