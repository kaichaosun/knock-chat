...
export const en = {
  ...
  groups: {
    ...
    copyLinkNote: "Send it to whoever you want in.",
  ...
  roomSettings: {
    ...
    directoryTitle: "Discoverable",
    directoryNote:
      "Anyone using Knock can find this group by name. Getting in still costs whatever the door asks.",
  ...
  discover: {
    ...
    members: "{{count}} in the room",
    runBy: "Run by {{who}}",
    nothingYet: "Nothing here yet",
    nothingYetNote: "No groups have been listed yet. Owners list theirs in the group's settings.",
    noMatch: "No groups by that name",
  ...
  contacts: {
    ...
    copyAddressNote: "Their full address, to pass on.",
    removeContact: "Remove contact",
    removeContactNote: "The chat goes. They'd have to knock again.",
  ...
  groupSheet: {
    icon: "Group icon",
    iconAdd: "Add an icon",
    iconAddNote: "Pick an image from this device.",
    iconChange: "Replace icon",
    iconChangeNote: "Pick a different image from this device.",
    iconRemove: "Remove icon",
    iconRemoveNote: "Go back to the faces of the people in the group.",
    iconSaved: "Group icon set",
    iconCleared: "Group icon removed",
    disbandedNote:
    ...
    leave: "Leave group",
    leaveNote: "You stop seeing what's said here.",
  ...
  profile: {
    ...
    yourName: "Your name",
    yourNameNote: "Anyone can pick any name — your address is what identifies you.",
    unnamed: "Unnamed",
    nameLabel: "Your name",
    save: "Save",
    ...
    nameCleared: "Name cleared",
    saveFailed: "Couldn't save",
    avatarMenu: "Your avatar",
    avatarChange: "Replace avatar",
    avatarChangeNote: "Pick a different image from this device.",
    avatarAdd: "Add an avatar",
    avatarAddNote: "Pick an image from this device. It's shown beside your name.",
    avatarRemove: "Remove avatar",
    avatarRemoveNote: "Go back to the icon your address makes.",
    avatarSaved: "Your avatar is set",
    avatarCleared: "Avatar removed",
    avatarTooBig: "That image is too large. Try one under {{max}} MB.",
    avatarNotAnImage: "That file isn't an image.",
  ...
  app: {
    ...
    discoverNote: "Rooms anyone can find by name.",
