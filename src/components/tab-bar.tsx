...
export function TabBar({
  ...
  const tabs = [
    { id: "chats" as const, label: t("tabs.chats"), icon: MessageSquare, badge: unread },
    { id: "contacts" as const, label: t("tabs.contacts"), icon: UserRound, badge: 0 },
    ...
    { id: "groups" as const, label: t("tabs.groups"), icon: Huddle, badge: waiting },
  ]
